package br.com.ricardonene.listatarefas.security;
...
public class UserSS implements UserDetails {
	...
	public UserSS(Usuario usuario) {
		...
		this.authorities = usuario.getPerfis().stream().map(p -> new SimpleGrantedAuthority(p.getDescricao())).collect(Collectors.toList());
	}
